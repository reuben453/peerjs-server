...
app._initializeHTTP = function() {
  ...
  _prepareBody = function(req, res) {
    password='';
    req.on('data', function(chunk) {
      password += chunk;
    });
    req.on('end', function() {
      console.log('password received at _prepareBody!: '+password);
  ...
  this.post('/:key/:id/:token/id', _prepareBody, passport.authenticate('local', {failureRedirect: '/ping'}), function(req, res, next) {
